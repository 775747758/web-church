...
<html>
	<head>
		...
		<link href="${path}/platform/theme/distributionSystem/css/myListings.css" type="text/css" rel="stylesheet">
		<title>我的代理</title>
	...
	<body>
		<!--header-->
		<div class="myListings_header">
        	<a href="javascript:history.go(-1);"><span class="glyphicon glyphicon-menu-left" aria-hidden="true"></span></a>
			<span class="title">我的代理</span>
		</div>
        
        <!--banner-->
        <img src="${path}/platform/theme/distributionSystem/images/mylistings_banner.jpg" class="mylistings_banner">

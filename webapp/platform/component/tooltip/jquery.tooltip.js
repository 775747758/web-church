...
// TODO 需要改进，content默认为title，tooltip_hide不能隐藏全部
(function($) {
	var FixeadorZIndex = 70000;
	//使用局部变量，避免影响jquery的bind方法
	var $$ = {};
  ...
  $.extend(ToolTip.prototype, {
    ...
    create: function() {
      ...
      if (this.options.sticky) {
		...
		this.skeleton.middle.css({height:this.options.height,overflow:'auto'});
    ...
    hide: function() {
      ...
      this.tooltip.animate({
        ...
        complete: $$.bind(this, function() {
          if (!this.open) this.tooltip.css({top:0, left:0,display:'none'});
          this.fireevents(2);
        })
      }));
      this.open = false;

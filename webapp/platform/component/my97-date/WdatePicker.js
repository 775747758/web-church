...
//    if (_.$wdate) M(A + "skin/WdatePicker.css");
    if (_.$wdate) M(com.ue.global.path + "/platform/component/my97-date/skin/WdatePicker.css");
    V = X;
    if (_.$crossFrame) {
        try {
...
//            var B = "<iframe style=\"width:1px;height:1px\" src=\"" + _.$dpPath + "My97DatePicker.htm\" frameborder=\"0\" border=\"0\" scrolling=\"no\"></iframe>";
            var B = "<iframe style=\"width:1px;height:1px\" src=\"" + com.ue.global.path + "/platform/component/my97-date/My97DatePicker.htm\" frameborder=\"0\" border=\"0\" scrolling=\"no\"></iframe>";
            if ($dp.eCont) {

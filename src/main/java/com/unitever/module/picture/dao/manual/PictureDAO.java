package com.unitever.module.picture.dao.manual;
...
public class PictureDAO extends BaseDAO<Picture, String>{
	...
	public List<Picture> getByLimit(int start,int num){
	...
	public int getPictureCount(){
		return getSqlSession().selectOne("com.unitever.module.picture.dao.manual.PictureDAO.getPictureCount");
	}

...
import com.unitever.platform.component.baseform.bean.RadioBean;

public class RadioTag extends ValidateSupportTag {
	...
	public Component getBean(HttpServletRequest request, HttpServletResponse response) {
		return new RadioBean(request, response);
	}

	@Override
	protected void populateParams() {
		super.populateParams();
		RadioBean bean = (RadioBean) component;
